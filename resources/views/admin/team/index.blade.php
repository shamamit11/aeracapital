                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <nav class="navbar navbar-light">
                                    ...
                                    <a href="{{ route('admin-team-add') }}" class="btn btn-primary my-2 my-sm-0 ms-1">
                                        Add</a>
                                </nav>
                            </div>
                            <div class="card-body">
                                @if ($teams->count() > 0)
                                        ...
                                        <table class="table">
                                            <thead class="table-light">
                                                <tr>
                                                    ...
                                                    <td width="200" style="text-align:center"> Order</td>
                                            ...
                                            <tbody>
                                                @foreach ($teams as $team)
                                                    <tr id="tr{{ $team->id }}">
                                                        ...
                                                        <td>{{ $team->name }}</td>
                                                        <td>{{ $team->position }}</td>
                                                        <td style="text-align:center">{{ $team->order }}</td>
                                                        <td><label class="switch">
                                                                <input class="switch-input switch-status" type="checkbox"
                                                                    data-id="{{ $team->id }}"
                                                                    data-status-value="{{ $team->status }}"
                                                        ...
                                                        <td style="text-align:center"><a
                                                                href="{{ route('admin-team-add', ['id=' . $team->id]) }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 col-sm-6 col-xs-12">
                                            <div class="float-end"> {{ $teams->links('pagination::bootstrap-4') }}
                                            </div>
                                        </div>
                                    </div>
                                @else
