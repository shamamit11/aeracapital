                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <nav class="navbar navbar-light">
                                    ...
                                    <a href="{{ route('admin-faq-add') }}" class="btn btn-primary my-2 my-sm-0 ms-1">
                                        Add</a>
                                </nav>
                            </div>
                            <div class="card-body">
                                @if ($faqs->count() > 0)
                                                ...
                                                <tr id="tr{{ $faq->id }}">
                                                    ...
                                                    <td align="center"><label class="switch">
                                                            <input class="switch-input switch-status" type="checkbox"
                                                                data-id="{{ $faq->id }}"
                                                                data-status-value="{{ $faq->status }}"
                                                                @if ($faq->status == 1) checked @endif /> <span
                                                                class="switch-label" data-on="Show" data-off="Hide"></span>
                                                            <span class="switch-handle"></span> </label></td>
                                                    <td style="text-align:center"><a
                                                            href="{{ route('admin-faq-add', ['id=' . $faq->id]) }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 col-sm-6 col-xs-12">
                                            <div class="float-end"> {{ $faqs->links('pagination::bootstrap-4') }} </div>
                                        </div>
                                    </div>
                                @else
