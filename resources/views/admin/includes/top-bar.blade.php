<div class="navbar-custom">
    <ul class="list-unstyled topnav-menu float-end mb-0">
        <li class="dropdown notification-list topbar-dropdown"> <a
                ...
                href="#" role="button" aria-haspopup="false" aria-expanded="false"> <img
                    src="{{ asset('assets/admin/images/aera-icon.svg') }}" alt="user-image" class="rounded-circle"> <span
    ...
    <div class="logo-box">
        <a href="{{ route('admin-dashboard') }}" class="logo logo-light text-center">
            <span class="logo-sm">
                <img src="{{ asset('assets/admin/images/aera-icon.svg') }}" alt="" height="35">
            </span>
            <span class="logo-lg">
                <img src="{{ asset('assets/admin/images/aera-logo.png') }}" alt="" height="80">
            </span>
        </a>
